...
- [#2206](https://github.com/openmls/openmls/pull/2206): `AddProposalIn::validate` now compares the key package's ciphersuite with the group's before verifying the key package, instead of after.
