...
use openmls_traits::{
    random::OpenMlsRand, storage::v1::StorageProvider, types::Ciphersuite, OpenMlsProvider,
};
...
fn codec_plaintext<Storage: StorageProvider<Types = crate::storage::OpenMlsTypes>>(
...
#[apply(ciphersuites_and_providers)]
fn unknown_sender<Storage: StorageProvider<Types = crate::storage::OpenMlsTypes>>(
    ciphersuite: Ciphersuite,
    provider: &impl OpenMlsProvider<StorageProvider = Storage>,
) {
...
#[apply(ciphersuites_and_providers)]
fn confirmation_tag_presence<Storage: StorageProvider<Types = crate::storage::OpenMlsTypes>>(
    ciphersuite: Ciphersuite,
    provider: &impl OpenMlsProvider<StorageProvider = Storage>,
) {
