...
/// Propose Group Context Extensions
#[derive(Error, Debug, PartialEq, Clone)]
pub enum ProposeGroupContextExtensionsError {
    /// TODO
    #[error("TODO")]
    Something,
    /// See [`LibraryError`] for more details.
...
pub enum ProposalError<KeyStoreError> {
    ...
    #[error(transparent)]
    ValidationError(#[from] ValidationError),
    /// See [`ProposeGroupContextExtensionsError`] for more details.
    #[error(transparent)]
    GroupContextExtensions(#[from] ProposeGroupContextExtensionsError),
}
