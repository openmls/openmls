...
use crate::{
    ...
    group::{
        errors::{CreateCommitError, ProposalValidationError},
        GroupId, MlsGroupCreateConfig, PURE_PLAINTEXT_WIRE_FORMAT_POLICY,
    },
...
fn commit_builder_fails_when_leaf_node_capabilities_insufficient() {
    ...
    assert!(
        matches!(
            err,
            GroupError::<Provider>::CreateCommit(CreateCommitError::ProposalValidationError(
