...
impl InitSecret {
    ...
    fn new(backend: &impl OpenMlsCrypto, epoch_secret: EpochSecret) -> Self {
        // FIXME: remove unwrap
...
impl WelcomeSecret {
    ...
    fn new(backend: &impl OpenMlsCrypto, intermediate_secret: &IntermediateSecret) -> Self {
        // FIXME: remove unwrap
        let secret = intermediate_secret
            .secret
    ...
    fn derive_aead_key(&self, backend: &impl OpenMlsCrypto) -> AeadKey {
        log::trace!(
    ...
    fn derive_aead_nonce(&self, backend: &impl OpenMlsCrypto) -> AeadNonce {
...
impl EpochSecrets {
    ...
    /// If the `init_secret` argument is `true`, the init secret is derived and
    /// part of the `EpochSecrets`. Otherwise not.
    fn new(backend: &impl OpenMlsCrypto, epoch_secret: EpochSecret, init_secret: bool) -> Self {
        log::debug!(
