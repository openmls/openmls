...
/// ```
#[derive(PartialEq, Debug, Clone, Serialize, TlsSize, TlsSerialize)]
pub struct FramedContentAuthData {
    pub signature: Signature,
    pub confirmation_tag: Option<ConfirmationTag>,
}

#[derive(Debug, PartialEq, Clone, Serialize, TlsSerialize, TlsSize)]
...
///
/// opaque MAC<V>;
#[derive(Debug, Clone, Serialize, TlsSerialize, TlsSize)]
pub struct Mac {
