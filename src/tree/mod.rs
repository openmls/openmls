...
impl RatchetTree {
    ...
    pub fn apply_proposals(
        ...
        for queued_proposal in proposal_queue.filtered_by_type(ProposalType::Update).iter() {
            has_updates = true;
        ...
        for queued_proposal in proposal_queue.filtered_by_type(ProposalType::Remove).iter() {
            has_removes = true;
